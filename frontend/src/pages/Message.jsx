...
const Message = () => {
    ...
    const [inputName, setInputName] = useState(user.firstName + user.lastName);
    ...
    return (
        <div className="min-h-screen w-[100vw] flex items-center justify-center bg-zinc-100 p-4 mt-5 font-inter">
                                    ...
                                    <div
                                        ...
                                        <div className="flex justify-between items-center mt-1 gap-16">
                                            <div className="text-[11px] font-bold">
                                                {m.sender}{' '}
                                                <span className={m.role === "Student" ? "text-yellow-900" : "text-red-700"}>
                                                    ({m.role})
                                                </span>
                                            </div>                                            <div className="text-[11px] text-gray-500 text-right">
                                                {formatTime(m.ts)}
                                            </div>
                                        </div>
                                    </div>
